...
export class StorageService {
  ...
  private getDefaultBadges(): Badge[] {
    return [
      ...
      { id: 'sortie_courageuse',  image: 'assets/icons/achivements/2-Humeurs/2SortieCourageuse.webp',         title: 'Sortie Courageuse',    description: 'Tu as fait 1 sortie notée "Anxieux" !',                     unlocked: false, dateUnlocked: null },
      { id: 'tu_laches_rien',     image: 'assets/icons/achivements/2-Humeurs/2TuNeLachesRien.webp',           title: 'Tu ne lâches rien',    description: 'Tu as fait 5 sorties notées "Anxieux" !',                   unlocked: false, dateUnlocked: null },
      { id: 'courage_quotidien',  image: 'assets/icons/achivements/2-Humeurs/2courageQuotidien.webp',         title: 'Courage Quotidien',    description: 'Tu as fait 10 sorties notées "Anxieux" !',                  unlocked: false, dateUnlocked: null },
