...
export class StorageService {
  ...
  getObjectifsEnCours(): Objectif[] {
    return this.objectifsSubject.getValue().filter((o) => o.statut === 'en cours');
  }

  // Retourne uniquement les objectifs terminés
  getObjectifsTermines(): Objectif[] {
    return this.objectifsSubject.getValue().filter((o) => o.statut === 'terminé');
  }

  // Retourne le nombre d'objectifs en cours
  getNombreObjectifsEnCours(): number {
    return this.objectifsSubject.getValue().filter((o) => o.statut === 'en cours').length;
  }

  // Retourne le nombre d'objectifs terminés
  getNombreObjectifsTermines(): number {
    return this.objectifsSubject.getValue().filter((o) => o.statut === 'terminé').length;
  }
  ...
  private getDefaultBadges(): Badge[] {
    return [
      { id: 'premiere_sortie',    image: 'assets/icons/achivements/1-NombresDeSorties/1PremiereSortie.webp',  title: 'Première Sortie',      description: 'Tu viens de commencer ton aventure !',                    unlocked: false, dateUnlocked: null },
      { id: 'en_mouvement',       image: 'assets/icons/achivements/1-NombresDeSorties/1EnMouvement.webp',     title: 'En mouvement',         description: 'Tu as fait 5 sorties !',                                  unlocked: false, dateUnlocked: null },
      { id: 'mira_active',        image: 'assets/icons/achivements/1-NombresDeSorties/1MiraActive.webp',      title: 'Mira Active',          description: 'Tu as fait 10 sorties !',                                 unlocked: false, dateUnlocked: null },
      { id: 'exploratrice',       image: 'assets/icons/achivements/1-NombresDeSorties/1Exploratrice.webp',    title: 'Exploratrice',         description: 'Tu as fait 20 sorties !',                                 unlocked: false, dateUnlocked: null },
      { id: 'aventurier',         image: 'assets/icons/achivements/1-NombresDeSorties/1Aventurier.webp',      title: 'Aventurier',           description: 'Tu as fait 30 sorties !',                                 unlocked: false, dateUnlocked: null },
      { id: 'nomade',             image: 'assets/icons/achivements/1-NombresDeSorties/1Nomade.webp',          title: 'Nomade',               description: 'Tu as fait 50 sorties !',                                 unlocked: false, dateUnlocked: null },
      { id: 'toujours_dehors',    image: 'assets/icons/achivements/1-NombresDeSorties/1ToujoursDehors.webp',  title: 'Toujours dehors',      description: 'Tu as fait 75 sorties !',                                 unlocked: false, dateUnlocked: null },
      { id: 'marathonien',        image: 'assets/icons/achivements/1-NombresDeSorties/1Maratonien.webp',      title: 'Maratonien',           description: 'Tu as fait 100 sorties !',                                unlocked: false, dateUnlocked: null },
      { id: 'inarretable',        image: 'assets/icons/achivements/1-NombresDeSorties/1Inarretable.webp',     title: 'Inarrêtable',          description: 'Tu as fait 150 sorties !',                                unlocked: false, dateUnlocked: null },
      { id: 'legende_sortie',     image: 'assets/icons/achivements/1-NombresDeSorties/1LegendesSortie.webp',  title: 'Légende de la Sortie', description: 'Tu as fait 200 sorties !',                                unlocked: false, dateUnlocked: null },
      { id: 'rayon_soleil',       image: 'assets/icons/achivements/2-Humeurs/2RayonDeSoleil.webp',            title: 'Rayon de Soleil',      description: 'Tu as fait 5 sorties notées "Tres bien" !',               unlocked: false, dateUnlocked: null },
      { id: 'energie_positive',   image: 'assets/icons/achivements/2-Humeurs/2EnergiePositive.webp',          title: 'Energie Positive',     description: 'Tu as fait 15 sorties notées "Tres bien" !',              unlocked: false, dateUnlocked: null },
      { id: 'humeur_or',          image: 'assets/icons/achivements/2-Humeurs/2HumeurEnOr.webp',               title: 'Humeur en Or',         description: 'Tu as fait 30 sorties notées "Tres bien" !',              unlocked: false, dateUnlocked: null },
      { id: 'bonne_vibes',        image: 'assets/icons/achivements/2-Humeurs/2BonneVibes.webp',               title: 'Bonne Vibes',          description: 'Tu as fait 5 sorties notées "Bien" !',                    unlocked: false, dateUnlocked: null },
      { id: 'optimiste',          image: 'assets/icons/achivements/2-Humeurs/2Optimiste.webp',                title: 'Optimiste',            description: 'Tu as fait 10 sorties notées "Bien" !',                   unlocked: false, dateUnlocked: null },
      { id: 'stable_sereine',     image: 'assets/icons/achivements/2-Humeurs/2StableEtSereine.webp',          title: 'Stable et Sereine',    description: 'Tu as fait 25 sorties notées "Bien" !',                   unlocked: false, dateUnlocked: null },
      { id: 'cava_aller',         image: 'assets/icons/achivements/2-Humeurs/2CavaAller.webp',                title: 'Ca va Aller',          description: 'Tu as fait 5 sorties notées "Moyen" !',                   unlocked: false, dateUnlocked: null },
      { id: 'tu_tiens_cap',       image: 'assets/icons/achivements/2-Humeurs/2TuTiensLeCap.webp',             title: 'Tu tiens le Cap',      description: 'Tu as fait 15 sorties notées "Moyen" !',                  unlocked: false, dateUnlocked: null },
      { id: 'ressilient',         image: 'assets/icons/achivements/2-Humeurs/2Ressilient.webp',               title: 'Ressilient',           description: 'Tu as fait 30 sorties notées "Moyen" !',                  unlocked: false, dateUnlocked: null },
      { id: 'sortie_courageuse',  image: 'assets/icons/achivements/2-Humeurs/2SortieCourageuse.webp',         title: 'Sortie Courageuse',    description: 'Tu as fait 1 sortie notée "Tendu" !',                     unlocked: false, dateUnlocked: null },
      { id: 'tu_laches_rien',     image: 'assets/icons/achivements/2-Humeurs/2TuNeLachesRien.webp',           title: 'Tu ne lâches rien',    description: 'Tu as fait 5 sorties notées "Tendu" !',                   unlocked: false, dateUnlocked: null },
      { id: 'courage_quotidien',  image: 'assets/icons/achivements/2-Humeurs/2courageQuotidien.webp',         title: 'Courage Quotidien',    description: 'Tu as fait 10 sorties notées "Tendu" !',                  unlocked: false, dateUnlocked: null },
      { id: 'petit_mieux',        image: 'assets/icons/achivements/3-Progression/3PetitMieux.webp',           title: 'Petit Mieux',          description: 'Une sortie avec une humeur meilleure que la précédente',  unlocked: false, dateUnlocked: null },
      { id: 'tu_progresses',      image: 'assets/icons/achivements/3-Progression/3Tuprograsse.webp',          title: 'Tu progresses',        description: "Tu as fait 5 sorties avec une amélioration d'humeur !",   unlocked: false, dateUnlocked: null },
      { id: 'bonne_dynamique',    image: 'assets/icons/achivements/3-Progression/3BonneDynamique.webp',       title: 'Bonne Dynamique',      description: "Tu as fait 10 sorties avec une amélioration d'humeur !",  unlocked: false, dateUnlocked: null },
      { id: 'ascension_positive', image: 'assets/icons/achivements/3-Progression/3AscensionPositive.webp',   title: 'Ascension Positive',   description: "Tu as fait 20 sorties avec une amélioration d'humeur !",  unlocked: false, dateUnlocked: null },
      { id: 'revenir_plus_fort',  image: 'assets/icons/achivements/3-Progression/3RevenirplusFort.webp',      title: 'Revenir plus Fort',    description: 'Tu as fait 1 sortie améliorée après un jour difficile !', unlocked: false, dateUnlocked: null },
      { id: 'resilience',         image: 'assets/icons/achivements/3-Progression/3Resilience.webp',           title: 'Résilience',           description: '3 sorties consécutives après une période tendue',         unlocked: false, dateUnlocked: null },
      ...
      { id: 'constance',          image: 'assets/icons/achivements/4-Repetitions/4Constance.webp',            title: 'Constance',            description: 'Tu as fait 30 sorties consécutives !',                    unlocked: false, dateUnlocked: null },
